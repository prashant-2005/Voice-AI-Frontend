...
const SignIn = () => {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center ' style={{ backgroundImage: `url(${bg})` }}>
      ...
      <form className='w-[90%] h-[550px] max-w-[450px] bg-[#00000075] backdrop-blur shadow-lg shadow-black rounded-4xl  flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn} >
        ...
        <button className='min-w-[120px] h-[50px] bg-white text-black font-semibold text-[19px] rounded-full mt-[20px] cursor-pointer ' disabled={loading}>{loading?"Loading...":"Sign In"}</button>

        <p className='text-white text-[18px] cursor-pointer' onClick={()=>navigate("/signup")}>Want to create a new aacount ? <span className='text-blue-400 '>Sign Up</span> </p>
